...
export const Equipamentos = () => {
    ...
    const Cadastrar = (event) => {
      ...
      axios({
        method: "post",
        url: "https://appgrupo1-task.azurewebsites.net/Equipamentos",
        data: formData,
    ...
    const Listar = () => {
      axios.get('https://appgrupo1-task.azurewebsites.net/Equipamentos')
      .then(resposta => {
    ...
    const Remover = (id) => {
      axios.delete('https://appgrupo1-task.azurewebsites.net/Equipamentos/'+id)
      .then(() => {
        Listar();
      })
      .catch(erro => console.log(erro))
          ...
          <main className="container">
            ...
            {produtos.map(item => 
              <div className="card" key={item.id}>
                <img src={"https://appgrupo1-task.azurewebsites.net/StaticFiles/Images/"+item.imagem} alt="" />
                <div>
